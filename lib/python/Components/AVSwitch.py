...
# Compiled at: 2021-11-19 01:44:58
...
class AVSwitch():
    print (
     'BoxBranding', 'MachineBuild', getMachineBuild())
    ...
    rates['PC'] = {'1024x768': {60: '1024x768'}, '800x600': {60: '800x600'}, '720x480': {60: '720x480'}, '720x576': {60: '720x576'}, '1280x720': {60: '1280x720'}, '1280x720 multi': {50: '1280x720_50', 60: '1280x720'}, '1920x1080': {60: '1920x1080'}, '1920x1080 multi': {50: '1920x1080', 60: '1920x1080_50'}, '1280x1024': {60: '1280x1024'}, '1366x768': {60: '1366x768'}, '1366x768 multi': {50: '1366x768', 60: '1366x768_50'}, '1280x768': {60: '1280x768'}, '640x480': {60: '640x480'}}
    ...
    def getOutputAspect(self):
        ...
        if port not in config.av.videomode:
            ...
            is_widescreen = force_widescreen or config.av.aspect.value in ('16:9',
                                                                           '16:10')
...
def InitAVSwitch():
    ...
    if SystemInfo['HDRSupport']:
        ...
        config.av.hlg_support = ConfigSelection(default='auto(EDID)', choices=[
         (
          'auto(EDID)', _('controlled by HDMI')), ('yes', _('force enabled')), ('no', _('force disabled'))])
    ...
    if SystemInfo['CanWMAPRO']:
        choices = [
         (
          'downmix', _('Downmix')), ('passthrough', _('Passthrough')), ('multichannel', _('convert to multi-channel PCM')), ('hdmi_best', _('use best / controlled by HDMI'))]
        default = 'downmix'
        if SystemInfo['CanProc']:
